...
/**
 * Class to explore and list the contents of a directory.
 * Provides functionality to list all files and directories,
 * optionally including subdirectories.
 * 
 * <p>
 * Original source: http://www.fobec.com/java/964/lister-fichiers-dossiers-repertoire.html
 * </p>
 * 
 * <p>
 * Example usage:
...
public class DiskFileExplorer {
    ...
    private static final Logger logger = Logger.getLogger(DiskFileExplorer.class);
     ...
     * @param subFolder Boolean flag to indicate if subdirectories should be included.
     */

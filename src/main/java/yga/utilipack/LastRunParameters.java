...
/**
 * The `LastRunParameters` class handles loading and saving of configuration
 * data from a file. It provides methods to load configuration data into memory
 * and save updated configuration data back to the file.
 */
public class LastRunParameters {

	private static final Logger logger = LogManager.getLogger(LastRunParameters.class);
	...
	public static void setFile(String file) {
		LastRunParameters.file = file;
	}

	/**
	 * Loads configuration data from the file specified by `file` into memory. Data
	 * is expected to be semicolon-separated.
	 */
	 ...
	 *
	 * @param values      the list of values to save in file
	 * @param separator the separator to use between data elements
	 * @throws FileNotFoundException        if the specified file path does not
	 *                                      exist
	 * @throws UnsupportedEncodingException if UTF-8 encoding is not supported
	 */
	public static void saveRunInfo(List<String> values, String separator)
